                ...
                <main class="mt-4">
                    ...
                    <section class="mt-5">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                            ...
                            <div class="col"><div class="card text-white genre-card"><img src="https://placehold.co/600x400/adb5bd/000?text=K-POP" class="card-img" alt="K-Pop"><div class="card-img-overlay"><h5 class="card-title fs-2 fw-bolder">K-Pop</h5><a href="kpop.php" class="btn btn-light fw-bold mt-2">Explorar</a></div></div></div>
