...
<head>
    ...
    <style>
        /* Estilos customizados - Tema K-Pop */
        body {
            font-family: 'Inter', sans-serif;
            background-color: #1a1a2e; /* Roxo bem escuro */
        }
        ...
        .sidebar-bg {
            background-color: #161625; /* Roxo um pouco mais escuro */
        }
        ...
        .kpop-text {
            color:rgb(255, 255, 255); /* Ciano Neon */
            text-shadow: 0 0 5px #ff3399, 0 0 10px #ff3399;
            font-style: italic;
            font-size: 2rem;
            align-self: center;
        }
