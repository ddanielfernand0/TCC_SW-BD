...
<head>
    ...
    <title>Music Player - Pop Edition</title>
    ...
    <style>
        /* Estilos customizados - Tema Pop Amarelo */
        :root {
            --pop-yellow: #ffc107;
            --pop-orange: #fd7e14;
        }
        ...
        .pop-text {
            font-weight: 800;
            font-size: 2rem;
            background: -webkit-linear-gradient(45deg, var(--pop-yellow), var(--pop-orange));
            ...
            <div class="container-fluid p-4">
                ...
                <header class="d-flex justify-content-between align-items-center py-3 border-bottom border-secondary sticky-top main-content-bg" style="z-index: 1020;">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="pop-text me-3">POP</span>
                        <div class="d-flex align-items-center">
